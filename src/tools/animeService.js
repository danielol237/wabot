...
const CURATED_CATALOG = [
  { title: "One Piece", aniListId: 21, year: "1999", rating: 9.0, episodes: 1100 },
  { title: "Naruto: Shippuden", aniListId: 1735, year: "2007", rating: 8.7, episodes: 500 },
  { title: "Demon Slayer", aniListId: 101922, year: "2019", rating: 8.6, episodes: 63 },
  { title: "Jujutsu Kaisen", aniListId: 113415, year: "2020", rating: 8.6, episodes: 47 },
  { title: "Dragon Ball Z", aniListId: 813, year: "1989", rating: 8.4, episodes: 291 },
  { title: "My Hero Academia", aniListId: 21459, year: "2016", rating: 8.0, episodes: 170 },
  { title: "Attack on Titan", aniListId: 16498, year: "2013", rating: 8.6, episodes: 89 },
  { title: "Solo Leveling", aniListId: 151807, year: "2024", rating: 8.7, episodes: 25 },
].map(({ title, aniListId, year, rating, episodes }) => ({
  id: `curated-${title.toLowerCase().replace(/[^a-z0-9]+/g, "-")}`,
  title,
  cover: `https://img.anili.st/media/${aniListId}`,
  description: "Open the title to view metadata, official watch links, and any configured authorized episode delivery.",
  overview: "A featured ARIA Anime pick with poster artwork and source-aware episode actions.",
  rating,
  year,
  episodes,
  type: "TV",
