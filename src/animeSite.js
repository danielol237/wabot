...
@media(max-width:680px){.quick-start{grid-template-columns:1fr;padding:18px}.quick-actions{justify-content:flex-start}.quick-actions .btn{flex:1}.quality-menu-pop{right:auto;left:0}}
</style></head><body>
