...
test("commandRouter: natural hidetag and tag-all requests resolve to group commands", () => {
  ...
  const routerSource = require("fs").readFileSync(require("path").join(__dirname, "../src/utils/commandRouter.js"), "utf8");
  assert.match(routerSource, /codingSubsystem\.handleCodingRequest/);
});
